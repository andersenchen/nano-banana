declare module "google-auth" {
  ...
  export interface GoogleAccounts {
    id: {
      ...
      cancel(): void;
      revoke(hint: string, callback?: (success: boolean) => void): void;
  ...
  export type SkippedReason = "auto_cancel" | "user_cancel" | "tap_outside" | "issuing_failed";

  export type DismissedReason = "credential_returned" | "cancel_called" | "flow_restarted";
